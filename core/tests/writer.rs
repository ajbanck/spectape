...
use spectape_core::parser::{parse_tap, parse_tzx};
use spectape_core::types::{ArchiveEntry, Block, Body, HardwareEntry, PilotRun, SymDef};
use spectape_core::writer::{
...
fn every_block() -> Vec<Block> {
    vec![
        ...
        b(Body::Return),
        b(Body::Select {
            entries: vec![spectape_core::types::SelectEntry { offset: 1, text: "Selection".into() }],
        }),
        b(Body::Stop48),
