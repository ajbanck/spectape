...
use spectape_core::pokes::{
    decode_pokes, encode_pokes, pokes_to_text, text_to_pokes, Poke, PokesInfo, Trainer,
};
use spectape_core::types::{create_body, Block, Body, RomTimings, SymDef};
...
fn converts_between_block_types() {
    ...
    for id in spectape_core::types::CREATABLE_IDS {
