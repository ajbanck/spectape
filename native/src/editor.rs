...
use spectape_core::content::{block_body, detect_content, ContentInfo, ContentKind};
use spectape_core::convert::convert_block;
use spectape_core::describe::{checksum, decode_header, encode_header, HeaderInfo, HEADER_TYPE_NAMES};
use spectape_core::pokes::{decode_pokes, encode_pokes, pokes_to_text, text_to_pokes};
use spectape_core::spectrum::basic::{basic_to_text, list_basic, BasicOptions};
use spectape_core::spectrum::screen::{render_screen, ScreenOptions};
use spectape_core::types::{
                ...
                ui.horizontal(|ui| {
                    ...
                    w::note(
                        ...
                        match self.content.source {
                            spectape_core::content::Source::Header => "from header",
                            spectape_core::content::Source::Heuristic => "guessed",
                            spectape_core::content::Source::None => "",
                        },
                    );
                });
            }
