...
export function Dialogs() {
  ...
  switch (d.kind) {
    ...
    case 'about':
      return (
        <Modal title="About SpecTape" onClose={close} footer={<button class="primary" onClick={close}>OK</button>}>
          <p><b>SpecTape</b> — an editor for ZX Spectrum TZX and TAP tape images, for the desktop and the browser.</p>
